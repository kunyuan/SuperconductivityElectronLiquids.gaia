...
```mermaid
graph LR
    downfolded_bse["Downfolded BSE (0.76)"]:::derived
    mu_vdiagmc_values["mu from vDiagMC: Numerical Values (0.50)"]:::derived
    dfpt_reliable_for_simple_metals["DFPT Reliable for Simple Metals (0.86)"]:::derived
    ab_initio_workflow["Ab Initio Tc Prediction Workflow (0.99)"]:::derived
    tc_al_predicted["Tc(Al) Ab Initio Prediction (0.93)"]:::derived
    tc_zn_predicted["Tc(Zn) Ab Initio Prediction (0.93)"]:::derived
    tc_li_predicted["Tc(Li) Ab Initio Prediction (0.96)"]:::derived
    al_pressure_transition["Al Pressure-Tc Transition (0.79)"]:::derived
    tc_mg_na_near_qpt["Na and Mg Near Quantum Phase Transition (0.79)"]:::derived
...
📌 `adiabatic_approx`   |   Prior: 0.95   |   Belief: **0.90**
...
📌 `bts_renormalization`   |   Prior: 0.95   |   Belief: **0.99**
...
📌 `rpa_predicts_attractive_mu`   |   Prior: 0.50   |   Belief: **0.25**
...
📌 `tc_li_experimental`   |   Prior: 0.85   |   Belief: **1.00**
...
📌 `tc_al_phenomenological`   |   Prior: 0.35   |   Belief: **0.40**
...
📌 `tc_zn_phenomenological`   |   Prior: 0.35   |   Belief: **0.40**
...
```mermaid
graph TD
    me_framework["Migdal-Eliashberg Framework (0.95)"]:::external
    electron_phonon_action["Electron-Phonon Action Decomposition (0.95)"]:::background
    bse_kernel_decomposition["BSE Kernel Decomposition (1.00)"]:::derived
...
📌 `bse_kernel_decomposition`   |   Belief: **1.00**
...
```mermaid
graph TD
    adiabatic_approx["Adiabatic Approximation (0.90)"]:::external
    bts_renormalization["BTS Renormalization Relation (0.99)"]:::external
    ...
    bse_kernel_decomposition["BSE Kernel Decomposition (1.00)"]:::external
    ...
    cross_term_suppressed["Cross-Channel Terms Suppressed (0.69)"]:::premise
    rpa_dynamic_screening["RPA Dynamic Screening"]:::setting
    full_bse_toy_model["Full BSE Toy Model Result (1.00)"]:::derived
    downfolded_bse_toy_model["Downfolded BSE Toy Model Result (0.76)"]:::derived
    downfolding_validity_limits["Downfolding Validity Limits (0.92)"]:::orphan
    downfolded_bse["Downfolded BSE (0.76)"]:::derived
    downfolded_me_equation["Downfolded ME Gap Equation (0.88)"]:::derived
    lambda_microscopic_definition["Microscopic Definition of lambda (0.81)"]:::derived
    mu_microscopic_definition["Microscopic Definition of mu (0.84)"]:::derived
    mu_scale_independence["BTS Relation as Corollary (0.99)"]:::derived
    bts_microscopic_equivalence["bts_microscopic_equivalence (1.00)"]:::derived
    ma_pseudopotential_justified["Morel-Anderson Ansatz Justified (0.92)"]:::derived
...
📌 `cross_term_suppressed`   |   Prior: 0.90   |   Belief: **0.69**
...
📌 `downfolded_bse_toy_model`   |   Belief: **0.76**
...
📌 `downfolded_me_equation`   |   Belief: **0.88**
...
📌 `lambda_microscopic_definition`   |   Belief: **0.81**
...
📌 `mu_microscopic_definition`   |   Belief: **0.84**
...
📌 `mu_scale_independence`   |   Belief: **0.99**
...
📌 `ma_pseudopotential_justified`   |   Belief: **0.92**
...
graph TD
    ...
    mu_microscopic_definition["Microscopic Definition of mu (0.84)"]:::external
    ueg_vertex_challenge["UEG Four-Point Vertex Challenge (0.95)"]:::background
    vdiagmc_method["vDiagMC Method (0.83)"]:::premise
    homotopic_expansion["Homotopic Expansion (0.79)"]:::premise
    mu_vdiagmc_values["mu from vDiagMC: Numerical Values (0.50)"]:::derived
...
📌 `vdiagmc_method`   |   Prior: 0.90   |   Belief: **0.83**
...
📌 `homotopic_expansion`   |   Prior: 0.88   |   Belief: **0.79**
...
graph TD
    ...
    lambda_microscopic_definition["Microscopic Definition of lambda (0.81)"]:::external
    ward_identity["Ward Identity at q->0 (1.00)"]:::premise
    gamma3_vdiagmc["vDiagMC Computation of Gamma_3 (1.00)"]:::premise
    dfpt_eph_ansatz["DFPT Expression for e-ph Coupling (0.90)"]:::background
    quasiparticle_mass_near_unity["Quasiparticle Mass Near Unity (0.86)"]:::premise
    eft_eph_vertex["EFT Electron-Phonon Vertex (0.86)"]:::derived
    gamma3_approximation["Approximate Gamma_3 within Fermi Sphere (0.91)"]:::derived
    eft_vertex_matches_dfpt["EFT Vertex Matches DFPT (0.85)"]:::derived
    dfpt_reliable_for_simple_metals["DFPT Reliable for Simple Metals (0.86)"]:::derived
    strat_12(["deduction"])
...
📌 `ward_identity`   |   Prior: 0.98   |   Belief: **1.00**
...
📌 `gamma3_vdiagmc`   |   Prior: 0.88   |   Belief: **1.00**
...
📌 `quasiparticle_mass_near_unity`   |   Prior: 0.92   |   Belief: **0.86**
...
📌 `gamma3_approximation`   |   Belief: **0.91**
...
📌 `eft_vertex_matches_dfpt`   |   Belief: **0.85**
...
📌 `dfpt_reliable_for_simple_metals`   |   Belief: **0.86**
...
graph TD
    ...
    tc_li_experimental["Tc(Li) Experimental (1.00)"]:::external
    tc_zn_experimental["Tc(Zn) Experimental (1.00)"]:::external
    tc_al_phenomenological["Tc(Al) Phenomenological Prediction (0.40)"]:::external
    tc_li_phenomenological["Tc(Li) Phenomenological Prediction (0.13)"]:::external
    tc_zn_phenomenological["Tc(Zn) Phenomenological Prediction (0.40)"]:::external
    precursory_cooper_flow["Precursory Cooper Flow (0.90)"]:::external
    downfolded_bse["Downfolded BSE (0.76)"]:::external
    mu_vdiagmc_values["mu from vDiagMC: Numerical Values (0.50)"]:::external
    dfpt_reliable_for_simple_metals["DFPT Reliable for Simple Metals (0.86)"]:::external
    ...
    ueg_pseudopotential_parameterization["UEG mu#ast; Parameterization and Mapping (0.83)"]:::premise
    ab_initio_workflow["Ab Initio Tc Prediction Workflow (0.99)"]:::derived
    mu_available_for_simple_metals["mu#ast; Available for Simple Metals (0.40)"]:::derived
    tc_al_predicted["Tc(Al) Ab Initio Prediction (0.93)"]:::derived
    tc_zn_predicted["Tc(Zn) Ab Initio Prediction (0.93)"]:::derived
    tc_li_predicted["Tc(Li) Ab Initio Prediction (0.96)"]:::derived
    al_pressure_transition["Al Pressure-Tc Transition (0.79)"]:::derived
...
📌 `ueg_pseudopotential_parameterization`   |   Prior: 0.85   |   Belief: **0.83**
...
📌 `ab_initio_workflow`   |   Belief: **0.99**
...
📌 `mu_available_for_simple_metals`   |   Belief: **0.40**
...
📌 `al_pressure_transition`   |   Belief: **0.79**
...
|-------|------|-------|--------|------|
| [tc_li_phenomenological](#tc_li_phenomenological) | claim | 0.10 | 0.1335 | independent |
| [rpa_predicts_attractive_mu](#rpa_predicts_attractive_mu) | claim | 0.50 | 0.2498 | independent |
| [tc_zn_phenomenological](#tc_zn_phenomenological) | claim | 0.35 | 0.3959 | independent |
| [tc_al_phenomenological](#tc_al_phenomenological) | claim | 0.35 | 0.3959 | independent |
| [mu_available_for_simple_metals](#mu_available_for_simple_metals) | claim | — | 0.4023 | derived |
| [mu_vdiagmc_values](#mu_vdiagmc_values) | claim | — | 0.5025 | derived |
| [cross_term_suppressed](#cross_term_suppressed) | claim | 0.90 | 0.6894 | independent |
| [downfolded_bse_toy_model](#downfolded_bse_toy_model) | claim | — | 0.7581 | derived |
| [downfolded_bse](#downfolded_bse) | claim | — | 0.7598 | derived |
| [al_pressure_transition](#al_pressure_transition) | claim | — | 0.7893 | derived |
| [tc_mg_na_near_qpt](#tc_mg_na_near_qpt) | claim | — | 0.7893 | derived |
| [homotopic_expansion](#homotopic_expansion) | claim | 0.88 | 0.7926 | independent |
| [lambda_microscopic_definition](#lambda_microscopic_definition) | claim | — | 0.8085 | derived |
| [vdiagmc_method](#vdiagmc_method) | claim | 0.90 | 0.8272 | independent |
| [ueg_pseudopotential_parameterization](#ueg_pseudopotential_parameterization) | claim | 0.85 | 0.8327 | independent |
| [mu_microscopic_definition](#mu_microscopic_definition) | claim | — | 0.8355 | derived |
| [eft_vertex_matches_dfpt](#eft_vertex_matches_dfpt) | claim | — | 0.8541 | derived |
| [eft_eph_vertex](#eft_eph_vertex) | claim | — | 0.8585 | derived |
| [quasiparticle_mass_near_unity](#quasiparticle_mass_near_unity) | claim | 0.92 | 0.8615 | independent |
| [dfpt_reliable_for_simple_metals](#dfpt_reliable_for_simple_metals) | claim | — | 0.8633 | derived |
| [downfolded_me_equation](#downfolded_me_equation) | claim | — | 0.8791 | derived |
...
| [adiabatic_approx](#adiabatic_approx) | claim | 0.95 | 0.9035 | independent |
| [gamma3_approximation](#gamma3_approximation) | claim | — | 0.9118 | derived |
| [ma_pseudopotential_justified](#ma_pseudopotential_justified) | claim | — | 0.9169 | derived |
...
| [tc_al_predicted](#tc_al_predicted) | claim | — | 0.9291 | derived |
| [tc_zn_predicted](#tc_zn_predicted) | claim | — | 0.9291 | derived |
...
| [me_framework](#me_framework) | claim | — | 0.9501 | derived |
| [tc_li_predicted](#tc_li_predicted) | claim | — | 0.9624 | derived |
| [ab_initio_workflow](#ab_initio_workflow) | claim | — | 0.9866 | derived |
| [mu_scale_independence](#mu_scale_independence) | claim | — | 0.9914 | derived |
| [bts_renormalization](#bts_renormalization) | claim | 0.95 | 0.9916 | independent |
| [full_bse_toy_model](#full_bse_toy_model) | claim | — | 0.9984 | derived |
| [bse_kernel_decomposition](#bse_kernel_decomposition) | claim | — | 0.9984 | derived |
| [rpa_vs_vdiagmc](#rpa_vs_vdiagmc) | claim | — | 0.9995 | structural |
| [tc_li_experimental](#tc_li_experimental) | claim | 0.85 | 0.9996 | independent |
| [bts_microscopic_equivalence](#bts_microscopic_equivalence) | claim | — | 0.9998 | structural |
| [gamma3_vdiagmc](#gamma3_vdiagmc) | claim | 0.88 | 0.9998 | independent |
| [ward_identity](#ward_identity) | claim | 0.98 | 1.0000 | independent |
| [tc_al_experimental](#tc_al_experimental) | claim | 0.99 | 1.0000 | independent |
| [tc_zn_experimental](#tc_zn_experimental) | claim | 0.99 | 1.0000 | independent |
