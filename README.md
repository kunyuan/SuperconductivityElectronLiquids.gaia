...
```mermaid
graph LR
    downfolded_bse["Downfolded BSE (0.22)"]:::derived
    mu_vdiagmc_values["mu from vDiagMC: Numerical Values (0.49)"]:::derived
    dfpt_reliable_for_simple_metals["DFPT Reliable for Simple Metals (0.69)"]:::derived
    ab_initio_workflow["Ab Initio Tc Prediction Workflow (0.52)"]:::derived
    tc_al_predicted["Tc(Al) Ab Initio Prediction (0.44)"]:::derived
    tc_zn_predicted["Tc(Zn) Ab Initio Prediction (0.44)"]:::derived
    tc_li_predicted["Tc(Li) Ab Initio Prediction (0.42)"]:::derived
    al_pressure_transition["Al Pressure-Tc Transition (0.42)"]:::derived
    tc_mg_na_near_qpt["Na and Mg Near Quantum Phase Transition (0.42)"]:::derived
...
📌 `adiabatic_approx`   |   Prior: 0.95   |   Belief: **0.67**
...
📌 `rpa_predicts_attractive_mu`   |   Prior: 0.50   |   Belief: **0.26**
...
📌 `tc_al_phenomenological`   |   Prior: 0.35   |   Belief: **0.35**
...
📌 `tc_li_phenomenological`   |   Prior: 0.10   |   Belief: **0.10**
...
📌 `tc_zn_phenomenological`   |   Prior: 0.35   |   Belief: **0.35**
...
```mermaid
graph TD
    me_framework["Migdal-Eliashberg Framework (0.70)"]:::external
...
📌 `bse_kernel_decomposition`   |   Belief: **0.73**
...
```mermaid
graph TD
    adiabatic_approx["Adiabatic Approximation (0.67)"]:::external
    ...
    bse_kernel_decomposition["BSE Kernel Decomposition (0.73)"]:::external
    ...
    cross_term_suppressed["Cross-Channel Terms Suppressed (0.43)"]:::premise
    rpa_dynamic_screening["RPA Dynamic Screening"]:::setting
    full_bse_toy_model["Full BSE Toy Model Result (0.70)"]:::derived
    downfolded_bse_toy_model["Downfolded BSE Toy Model Result (0.21)"]:::derived
    downfolding_validity_limits["Downfolding Validity Limits (0.92)"]:::orphan
    downfolded_bse["Downfolded BSE (0.22)"]:::derived
    downfolded_me_equation["Downfolded ME Gap Equation (0.61)"]:::derived
    lambda_microscopic_definition["Microscopic Definition of lambda (0.44)"]:::derived
    mu_microscopic_definition["Microscopic Definition of mu (0.47)"]:::derived
    ...
    ma_pseudopotential_justified["Morel-Anderson Ansatz Justified (0.73)"]:::derived
...
📌 `cross_term_suppressed`   |   Prior: 0.90   |   Belief: **0.43**
...
📌 `full_bse_toy_model`   |   Belief: **0.70**
...
📌 `downfolded_bse_toy_model`   |   Belief: **0.21**
...
📌 `downfolded_me_equation`   |   Belief: **0.61**
...
📌 `lambda_microscopic_definition`   |   Belief: **0.44**
...
📌 `mu_microscopic_definition`   |   Belief: **0.47**
...
📌 `ma_pseudopotential_justified`   |   Belief: **0.73**
...
graph TD
    bts_renormalization["BTS Renormalization Relation (0.97)"]:::external
    rpa_predicts_attractive_mu["RPA Predicts Attractive mu#ast; (0.26)"]:::external
    mu_microscopic_definition["Microscopic Definition of mu (0.47)"]:::external
    ueg_vertex_challenge["UEG Four-Point Vertex Challenge (0.95)"]:::background
    vdiagmc_method["vDiagMC Method (0.82)"]:::premise
...
📌 `vdiagmc_method`   |   Prior: 0.90   |   Belief: **0.82**
...
graph TD
    ...
    lambda_microscopic_definition["Microscopic Definition of lambda (0.44)"]:::external
    ...
    quasiparticle_mass_near_unity["Quasiparticle Mass Near Unity (0.89)"]:::premise
    eft_eph_vertex["EFT Electron-Phonon Vertex (0.67)"]:::derived
    gamma3_approximation["Approximate Gamma_3 within Fermi Sphere (0.34)"]:::derived
    eft_vertex_matches_dfpt["EFT Vertex Matches DFPT (0.46)"]:::derived
    dfpt_reliable_for_simple_metals["DFPT Reliable for Simple Metals (0.69)"]:::derived
    strat_12(["deduction"])
...
📌 `quasiparticle_mass_near_unity`   |   Prior: 0.92   |   Belief: **0.89**
...
📌 `gamma3_approximation`   |   Belief: **0.34**
...
📌 `eft_vertex_matches_dfpt`   |   Belief: **0.46**
...
📌 `dfpt_reliable_for_simple_metals`   |   Belief: **0.69**
...
graph TD
    ...
    tc_al_phenomenological["Tc(Al) Phenomenological Prediction (0.35)"]:::external
    tc_li_phenomenological["Tc(Li) Phenomenological Prediction (0.10)"]:::external
    tc_zn_phenomenological["Tc(Zn) Phenomenological Prediction (0.35)"]:::external
    precursory_cooper_flow["Precursory Cooper Flow (0.90)"]:::external
    downfolded_bse["Downfolded BSE (0.22)"]:::external
    mu_vdiagmc_values["mu from vDiagMC: Numerical Values (0.49)"]:::external
    dfpt_reliable_for_simple_metals["DFPT Reliable for Simple Metals (0.69)"]:::external
    ...
    ab_initio_workflow["Ab Initio Tc Prediction Workflow (0.52)"]:::derived
    mu_available_for_simple_metals["mu#ast; Available for Simple Metals (0.38)"]:::derived
    tc_al_predicted["Tc(Al) Ab Initio Prediction (0.44)"]:::derived
    tc_zn_predicted["Tc(Zn) Ab Initio Prediction (0.44)"]:::derived
    tc_li_predicted["Tc(Li) Ab Initio Prediction (0.42)"]:::derived
    al_pressure_transition["Al Pressure-Tc Transition (0.42)"]:::derived
...
📌 `ab_initio_workflow`   |   Belief: **0.52**
...
📌 `mu_available_for_simple_metals`   |   Belief: **0.38**
...
📌 `al_pressure_transition`   |   Belief: **0.42**
...
|-------|------|-------|--------|------|
| [tc_li_phenomenological](#tc_li_phenomenological) | claim | 0.10 | 0.1000 | independent |
| [downfolded_bse_toy_model](#downfolded_bse_toy_model) | claim | — | 0.2063 | derived |
| [downfolded_bse](#downfolded_bse) | claim | — | 0.2163 | derived |
| [rpa_predicts_attractive_mu](#rpa_predicts_attractive_mu) | claim | 0.50 | 0.2576 | independent |
| [gamma3_approximation](#gamma3_approximation) | claim | — | 0.3372 | derived |
| [tc_al_phenomenological](#tc_al_phenomenological) | claim | 0.35 | 0.3500 | independent |
| [tc_zn_phenomenological](#tc_zn_phenomenological) | claim | 0.35 | 0.3500 | independent |
| [mu_available_for_simple_metals](#mu_available_for_simple_metals) | claim | — | 0.3833 | derived |
| [al_pressure_transition](#al_pressure_transition) | claim | — | 0.4153 | derived |
| [tc_li_predicted](#tc_li_predicted) | claim | — | 0.4153 | derived |
| [tc_mg_na_near_qpt](#tc_mg_na_near_qpt) | claim | — | 0.4153 | derived |
| [cross_term_suppressed](#cross_term_suppressed) | claim | 0.90 | 0.4346 | independent |
| [lambda_microscopic_definition](#lambda_microscopic_definition) | claim | — | 0.4412 | derived |
| [tc_al_predicted](#tc_al_predicted) | claim | — | 0.4412 | derived |
| [tc_zn_predicted](#tc_zn_predicted) | claim | — | 0.4412 | derived |
| [eft_vertex_matches_dfpt](#eft_vertex_matches_dfpt) | claim | — | 0.4574 | derived |
| [mu_microscopic_definition](#mu_microscopic_definition) | claim | — | 0.4681 | derived |
| [mu_vdiagmc_values](#mu_vdiagmc_values) | claim | — | 0.4867 | derived |
| [ab_initio_workflow](#ab_initio_workflow) | claim | — | 0.5185 | derived |
| [downfolded_me_equation](#downfolded_me_equation) | claim | — | 0.6079 | derived |
| [eft_eph_vertex](#eft_eph_vertex) | claim | — | 0.6658 | derived |
| [adiabatic_approx](#adiabatic_approx) | claim | 0.95 | 0.6736 | independent |
| [dfpt_reliable_for_simple_metals](#dfpt_reliable_for_simple_metals) | claim | — | 0.6868 | derived |
| [full_bse_toy_model](#full_bse_toy_model) | claim | — | 0.6972 | derived |
| [me_framework](#me_framework) | claim | — | 0.7032 | derived |
| [ma_pseudopotential_justified](#ma_pseudopotential_justified) | claim | — | 0.7336 | derived |
| [bse_kernel_decomposition](#bse_kernel_decomposition) | claim | — | 0.7337 | derived |
| [homotopic_expansion](#homotopic_expansion) | claim | 0.88 | 0.7860 | independent |
| [vdiagmc_method](#vdiagmc_method) | claim | 0.90 | 0.8217 | independent |
| [ueg_pseudopotential_parameterization](#ueg_pseudopotential_parameterization) | claim | 0.85 | 0.8274 | independent |
...
| [quasiparticle_mass_near_unity](#quasiparticle_mass_near_unity) | claim | 0.92 | 0.8871 | independent |
...
| [mu_scale_independence](#mu_scale_independence) | claim | — | 0.9724 | derived |
| [bts_renormalization](#bts_renormalization) | claim | 0.95 | 0.9733 | independent |
