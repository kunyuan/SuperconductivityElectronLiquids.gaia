...
```mermaid
graph LR
    downfolded_bse["Downfolded BSE (0.18)"]:::derived
    mu_vdiagmc_values["mu from vDiagMC: Numerical Values (0.60)"]:::derived
    dfpt_reliable_for_simple_metals["DFPT Reliable for Simple Metals (0.78)"]:::derived
    ab_initio_workflow["Ab Initio Tc Prediction Workflow (1.00)"]:::derived
    tc_al_predicted["Tc(Al) Ab Initio Prediction (0.99)"]:::derived
    tc_zn_predicted["Tc(Zn) Ab Initio Prediction (0.99)"]:::derived
    tc_li_predicted["Tc(Li) Ab Initio Prediction (0.25)"]:::derived
    al_pressure_transition["Al Pressure-Tc Transition (0.80)"]:::derived
    tc_mg_na_near_qpt["Na and Mg Near Quantum Phase Transition (0.80)"]:::derived
...
📌 `bts_renormalization`   |   Belief: **0.97**
...
📌 `me_downfolding_is_phenomenological`   |   Belief: **0.95**
...
📌 `phenomenological_me_theory`   |   Belief: **0.95**
...
📌 `mu_star_phenomenological`   |   Belief: **1.00**
...
📌 `rpa_predicts_attractive_mu`   |   Belief: **0.20**
...
📌 `dfpt_computes_lambda`   |   Belief: **1.00**
...
📌 `tc_al_experimental`   |   Belief: **0.99**
...
📌 `tc_li_experimental`   |   Belief: **0.24**
...
📌 `tc_zn_experimental`   |   Belief: **0.99**
...
📌 `tc_al_phenomenological`   |   Belief: **0.98**
...
📌 `tc_li_phenomenological`   |   Belief: **0.21**
...
📌 `tc_zn_phenomenological`   |   Belief: **0.98**
...
```mermaid
graph TD
    me_framework["Migdal-Eliashberg Framework (0.71)"]:::external
    electron_phonon_action["Electron-Phonon Action Decomposition (0.95)"]:::background
    bse_kernel_decomposition["BSE Kernel Decomposition (0.74)"]:::derived
...
📌 `electron_phonon_action`   |   Belief: **0.95**
...
📌 `bse_kernel_decomposition`   |   Belief: **0.74**
...
📌 `precursory_cooper_flow`   |   Belief: **0.90**
...
```mermaid
graph TD
    adiabatic_approx["Adiabatic Approximation (0.68)"]:::external
    bts_renormalization["BTS Renormalization Relation (0.97)"]:::external
    mu_star_phenomenological["mu#ast; as Phenomenological Parameter (1.00)"]:::external
    electron_phonon_action["Electron-Phonon Action Decomposition (0.95)"]:::external
    bse_kernel_decomposition["BSE Kernel Decomposition (0.74)"]:::external
    ...
    cross_term_suppressed["Cross-Channel Terms Suppressed (0.41)"]:::premise
    rpa_dynamic_screening["RPA Dynamic Screening"]:::setting
    full_bse_toy_model["Full BSE Toy Model Result (0.71)"]:::derived
    downfolded_bse_toy_model["Downfolded BSE Toy Model Result (0.71)"]:::derived
    downfolding_validity_limits["Downfolding Validity Limits (0.92)"]:::orphan
    downfolded_bse["Downfolded BSE (0.18)"]:::derived
    downfolded_me_equation["Downfolded ME Gap Equation (0.59)"]:::derived
    lambda_microscopic_definition["Microscopic Definition of lambda (0.35)"]:::derived
    mu_microscopic_definition["Microscopic Definition of mu (0.44)"]:::derived
    ...
    ma_pseudopotential_justified["Morel-Anderson Ansatz Justified (0.72)"]:::derived
...
📌 `cross_term_suppressed`   |   Belief: **0.41**
...
📌 `full_bse_toy_model`   |   Belief: **0.71**
...
📌 `downfolded_bse_toy_model`   |   Belief: **0.71**
...
📌 `downfolding_validity_limits`   |   Belief: **0.92**
...
📌 `downfolded_me_equation`   |   Belief: **0.59**
...
📌 `lambda_microscopic_definition`   |   Belief: **0.35**
...
📌 `mu_microscopic_definition`   |   Belief: **0.44**
...
📌 `ma_pseudopotential_justified`   |   Belief: **0.72**
...
graph TD
    bts_renormalization["BTS Renormalization Relation (0.97)"]:::external
    rpa_predicts_attractive_mu["RPA Predicts Attractive mu#ast; (0.20)"]:::external
    mu_microscopic_definition["Microscopic Definition of mu (0.44)"]:::external
    ueg_vertex_challenge["UEG Four-Point Vertex Challenge (0.95)"]:::background
    vdiagmc_method["vDiagMC Method (0.86)"]:::premise
...
📌 `ueg_vertex_challenge`   |   Belief: **0.95**
...
📌 `homotopic_expansion`   |   Belief: **0.84**
...
```mermaid
graph TD
    dfpt_computes_lambda["DFPT Computes lambda (1.00)"]:::external
    lambda_microscopic_definition["Microscopic Definition of lambda (0.35)"]:::external
    ward_identity["Ward Identity at q->0 (0.99)"]:::premise
    gamma3_vdiagmc["vDiagMC Computation of Gamma_3 (0.98)"]:::premise
    dfpt_eph_ansatz["DFPT Expression for e-ph Coupling (0.90)"]:::background
    quasiparticle_mass_near_unity["Quasiparticle Mass Near Unity (0.87)"]:::premise
    eft_eph_vertex["EFT Electron-Phonon Vertex (0.52)"]:::derived
    gamma3_approximation["Approximate Gamma_3 within Fermi Sphere (0.96)"]:::derived
    eft_vertex_matches_dfpt["EFT Vertex Matches DFPT (0.67)"]:::derived
    dfpt_reliable_for_simple_metals["DFPT Reliable for Simple Metals (0.78)"]:::derived
    strat_11(["deduction"])
    ...
    strat_14(["induction"]):::weak
    ward_identity --> strat_14
    gamma3_vdiagmc --> strat_14
    strat_14 --> gamma3_approximation
    strat_15(["deduction"])
    eft_eph_vertex --> strat_15
    gamma3_approximation --> strat_15
    dfpt_eph_ansatz -.-> strat_15
    strat_15 --> eft_vertex_matches_dfpt
    strat_16(["deduction"])
    eft_vertex_matches_dfpt --> strat_16
    quasiparticle_mass_near_unity --> strat_16
    dfpt_computes_lambda -.-> strat_16
...
📌 `quasiparticle_mass_near_unity`   |   Belief: **0.87**
...
📌 `gamma3_approximation`   |   Belief: **0.96**
...
📌 `eft_vertex_matches_dfpt`   |   Belief: **0.67**
...
📌 `dfpt_reliable_for_simple_metals`   |   Belief: **0.78**
...
graph TD
    bts_renormalization["BTS Renormalization Relation (0.97)"]:::external
    precursory_cooper_flow["Precursory Cooper Flow (0.90)"]:::external
    downfolded_bse["Downfolded BSE (0.18)"]:::external
    mu_vdiagmc_values["mu from vDiagMC: Numerical Values (0.60)"]:::external
    dfpt_reliable_for_simple_metals["DFPT Reliable for Simple Metals (0.78)"]:::external
    ...
    ueg_pseudopotential_parameterization["UEG mu#ast; Parameterization and Mapping (0.86)"]:::premise
    ab_initio_workflow["Ab Initio Tc Prediction Workflow (1.00)"]:::derived
    mu_available_for_simple_metals["mu#ast; Available for Simple Metals (0.46)"]:::derived
    tc_al_predicted["Tc(Al) Ab Initio Prediction (0.99)"]:::derived
    tc_zn_predicted["Tc(Zn) Ab Initio Prediction (0.99)"]:::derived
    tc_li_predicted["Tc(Li) Ab Initio Prediction (0.25)"]:::derived
    al_pressure_transition["Al Pressure-Tc Transition (0.80)"]:::derived
    ...
    strat_18 --> mu_available_for_simple_metals
    strat_19(["deduction"])
    downfolded_bse --> strat_19
    mu_available_for_simple_metals --> strat_19
    dfpt_reliable_for_simple_metals --> strat_19
    strat_19 --> ab_initio_workflow
    strat_20(["infer"]):::weak
    downfolded_bse --> strat_20
    mu_vdiagmc_values --> strat_20
    dfpt_reliable_for_simple_metals --> strat_20
    ueg_pseudopotential_parameterization --> strat_20
    simple_metals_weak_lattice -.-> strat_20
    bts_renormalization -.-> strat_20
    strat_20 --> ab_initio_workflow
    strat_21(["support"]):::weak
    ab_initio_workflow --> strat_21
    aluminum_parameters -.-> strat_21
    strat_21 --> tc_al_predicted
    strat_22(["support"]):::weak
    ab_initio_workflow --> strat_22
    zinc_parameters -.-> strat_22
    strat_22 --> tc_zn_predicted
    strat_23(["support"]):::weak
    ab_initio_workflow --> strat_23
    lithium_parameters -.-> strat_23
    strat_23 --> tc_li_predicted
    strat_24(["support"]):::weak
    ab_initio_workflow --> strat_24
    aluminum_parameters -.-> strat_24
    strat_24 --> al_pressure_transition
    strat_25(["support"]):::weak
    ab_initio_workflow --> strat_25
    magnesium_parameters -.-> strat_25
    sodium_parameters -.-> strat_25
    precursory_cooper_flow -.-> strat_25
    strat_25 --> tc_mg_na_near_qpt
    oper_1{{"≡"}}
    bts_renormalization --- oper_1
    oper_2{{"⊗"}}:::contra
    mu_vdiagmc_values --- oper_2
...
📌 `simple_metals_weak_lattice`   |   Belief: **0.90**
...
📌 `ueg_pseudopotential_parameterization`   |   Belief: **0.86**
...
📌 `ab_initio_workflow`   |   Belief: **1.00**
...
📌 `mu_available_for_simple_metals`   |   Belief: **0.46**
...
📌 `al_pressure_transition`   |   Belief: **0.80**
...
|-------|------|-------|--------|------|
| [downfolded_bse](#downfolded_bse) | claim | — | 0.1782 | derived |
| [rpa_predicts_attractive_mu](#rpa_predicts_attractive_mu) | claim | — | 0.2023 | independent |
| [tc_li_phenomenological](#tc_li_phenomenological) | claim | — | 0.2109 | derived |
| [tc_li_experimental](#tc_li_experimental) | claim | — | 0.2448 | independent |
| [tc_li_predicted](#tc_li_predicted) | claim | — | 0.2477 | derived |
| [lambda_microscopic_definition](#lambda_microscopic_definition) | claim | — | 0.3514 | derived |
| [cross_term_suppressed](#cross_term_suppressed) | claim | — | 0.4131 | independent |
| [mu_microscopic_definition](#mu_microscopic_definition) | claim | — | 0.4422 | derived |
| [mu_available_for_simple_metals](#mu_available_for_simple_metals) | claim | — | 0.4559 | derived |
| [eft_eph_vertex](#eft_eph_vertex) | claim | — | 0.5234 | derived |
| [downfolded_me_equation](#downfolded_me_equation) | claim | — | 0.5888 | derived |
| [mu_vdiagmc_values](#mu_vdiagmc_values) | claim | — | 0.5979 | derived |
| [eft_vertex_matches_dfpt](#eft_vertex_matches_dfpt) | claim | — | 0.6698 | derived |
| [adiabatic_approx](#adiabatic_approx) | claim | — | 0.6842 | independent |
| [downfolded_bse_toy_model](#downfolded_bse_toy_model) | claim | — | 0.7072 | derived |
| [full_bse_toy_model](#full_bse_toy_model) | claim | — | 0.7076 | derived |
| [me_framework](#me_framework) | claim | — | 0.7090 | derived |
| [ma_pseudopotential_justified](#ma_pseudopotential_justified) | claim | — | 0.7202 | derived |
| [bse_kernel_decomposition](#bse_kernel_decomposition) | claim | — | 0.7355 | derived |
| [dfpt_reliable_for_simple_metals](#dfpt_reliable_for_simple_metals) | claim | — | 0.7838 | derived |
| [al_pressure_transition](#al_pressure_transition) | claim | — | 0.7974 | derived |
| [tc_mg_na_near_qpt](#tc_mg_na_near_qpt) | claim | — | 0.7974 | derived |
| [homotopic_expansion](#homotopic_expansion) | claim | — | 0.8376 | independent |
| [ueg_pseudopotential_parameterization](#ueg_pseudopotential_parameterization) | claim | — | 0.8592 | independent |
| [vdiagmc_method](#vdiagmc_method) | claim | — | 0.8646 | independent |
| [quasiparticle_mass_near_unity](#quasiparticle_mass_near_unity) | claim | — | 0.8746 | independent |
| [dfpt_eph_ansatz](#dfpt_eph_ansatz) | claim | — | 0.9000 | background |
| [precursory_cooper_flow](#precursory_cooper_flow) | claim | — | 0.9000 | background |
| [simple_metals_weak_lattice](#simple_metals_weak_lattice) | claim | — | 0.9000 | background |
| [downfolding_validity_limits](#downfolding_validity_limits) | claim | — | 0.9200 | orphaned |
| [electron_phonon_action](#electron_phonon_action) | claim | — | 0.9500 | background |
| [me_downfolding_is_phenomenological](#me_downfolding_is_phenomenological) | claim | — | 0.9500 | orphaned |
| [phenomenological_me_theory](#phenomenological_me_theory) | claim | — | 0.9500 | orphaned |
| [ueg_vertex_challenge](#ueg_vertex_challenge) | claim | — | 0.9500 | background |
| [gamma3_approximation](#gamma3_approximation) | claim | — | 0.9622 | derived |
| [mu_scale_independence](#mu_scale_independence) | claim | — | 0.9711 | derived |
| [bts_renormalization](#bts_renormalization) | claim | — | 0.9720 | independent |
| [gamma3_vdiagmc](#gamma3_vdiagmc) | claim | — | 0.9809 | independent |
| [tc_al_phenomenological](#tc_al_phenomenological) | claim | — | 0.9848 | derived |
| [tc_zn_phenomenological](#tc_zn_phenomenological) | claim | — | 0.9848 | derived |
| [ward_identity](#ward_identity) | claim | — | 0.9895 | independent |
| [tc_al_predicted](#tc_al_predicted) | claim | — | 0.9914 | derived |
| [tc_zn_predicted](#tc_zn_predicted) | claim | — | 0.9914 | derived |
| [tc_al_experimental](#tc_al_experimental) | claim | — | 0.9916 | independent |
| [tc_zn_experimental](#tc_zn_experimental) | claim | — | 0.9916 | independent |
| [ab_initio_workflow](#ab_initio_workflow) | claim | — | 0.9975 | derived |
...
| [dfpt_computes_lambda](#dfpt_computes_lambda) | claim | — | 1.0000 | independent |
| [mu_star_phenomenological](#mu_star_phenomenological) | claim | — | 1.0000 | independent |
