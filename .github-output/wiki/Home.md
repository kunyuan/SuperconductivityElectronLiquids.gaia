...
| li_crystal_structure_at_low_t | claim | motivation | 0.50 |
| li_is_superconducting | claim | motivation | 0.75 |
| li_anomaly_not_sc | claim | motivation | 0.25 |
|  | claim | motivation | 1.00 |
| li_zero_resistance_observed | claim | motivation | 1.00 |
|  | claim | motivation | 0.50 |
|  | claim | motivation | 0.50 |
| li_meissner_observed | claim | motivation | 0.74 |
|  | claim | motivation | 0.50 |
| li_meissner_inquiry | question | motivation | — |
| main_question | question | motivation | — |
| electron_phonon_action | claim | s2_model | 0.50 |
| bse_kernel_decomposition | claim | s2_model | 0.99 |
|  | claim | s2_model | 0.50 |
...
| full_bse_toy_model | claim | s3_downfolding | 1.00 |
|  | claim | s3_downfolding | 0.50 |
| downfolded_bse_toy_model | claim | s3_downfolding | 1.00 |
|  | claim | s3_downfolding | 0.50 |
| bse_toy_model_equivalence | claim | s3_downfolding | 1.00 |
| downfolded_me_equation | claim | s3_downfolding | 0.95 |
|  | claim | s3_downfolding | 0.50 |
...
| gamma3_vdiagmc | claim | s5_eph_coupling | 0.84 |
|  | claim | s5_eph_coupling | 0.50 |
| dfpt_eph_ansatz | claim | s5_eph_coupling | 0.50 |
| quasiparticle_mass_near_unity | claim | s5_eph_coupling | 0.93 |
...
|  | claim | s6_superconductors | 0.50 |
| al_pressure_transition | claim | s6_superconductors | 0.98 |
|  | claim | s6_superconductors | 0.50 |
| tc_mg_na_near_qpt | claim | s6_superconductors | 0.98 |
|  | claim | s6_superconductors | 0.50 |
