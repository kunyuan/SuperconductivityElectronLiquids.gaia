...
**Type:** setting
**Role:** setting
**Content:** Bardeen-Cooper-Schrieffer (BCS) theory [@BCS1957]: phonon-mediated electron-electron attraction leads to Cooper pairing instability at the Fermi surface, providing the fundamental framework for understanding conventional superconductors.
**gaia:** {'provenance': {'cited_refs': ['BCS1957']}}
...
**gaia:** {'provenance': {'cited_refs': ['Eliashberg1960', 'Migdal1958'], 'referenced_claims': ['adiabatic_approx', 'bcs_theory']}}
